...
public:
    ...
    [[nodiscard]] double get_score_on_subtask(const std::string &username, const Testset &testset, const Subtask &subtask) const;
    [[nodiscard]] double get_score_on_test(const std::string &username, const Testset &testset, const Subtask &subtask, const Test &test) const;
