...
class DataSenderSessionEventHandler : public socket::SessionEventHandler {
public:
    DataSenderSessionEventHandler();
    ...
    constexpr static auto REGISTERED_NAME = "DataSenderSessionEventHandler";
